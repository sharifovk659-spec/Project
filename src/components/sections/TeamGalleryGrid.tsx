  ...
  return (
    <>
      <motion.div
        ...
        className="mt-8 grid grid-cols-1 gap-3 sm:mt-10 sm:grid-cols-2 sm:gap-4 lg:grid-cols-3"
      >
        {TEAM_GALLERY_IMAGES.map((src, index) => (
          <motion.button
            ...
            className="group relative aspect-[16/10] cursor-zoom-in overflow-hidden rounded-lg border border-gold/15 bg-dark text-left transition-[border-color,box-shadow] hover:border-gold/35 hover:shadow-[0_0_24px_rgba(200,155,92,0.12)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold/50"
          ...
          >
            <Image
              ...
              sizes={IMAGE_SIZES.teamGalleryGrid}
              quality={IMAGE_QUALITY_HIGH}
